...
public class StringConsumidor extends Thread {
	...
	public void run() {
		...
		while (true) {
			try {
				// lamamos  dequeue directamente, porque el consumidor no tiene que
				...
				// sus recursos por tanto, el consumidor llama, y si la cola
				// decide si sirve,
				// pone en espera, o lo que haga falta.
				temp = buffer.dequeue();
